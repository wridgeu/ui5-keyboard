...
### Three UI5 configurations

The app ships one `ui5.yaml` per way it runs. The two SAPUI5 ones exist because the Fiori Launchpad shell (`sap.ushell`) is not part of OpenUI5.

| Config           | Framework      | Used by                                           | What it serves or builds                                                                                      |
| ---------------- | -------------- | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `ui5.yaml`       | OpenUI5        | `npm start`, `npm run build:demo`                 | The standalone app at `index.html`                                                                            |
