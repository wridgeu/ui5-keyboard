...
```html
<ui5-li accessible-role="menuitem"> List Item</ui5-li> <ui5-list accessible-role="tree"> List </ui5-list>
```
...
```html
<ui5-button id="opener">Open</ui5-button> <ui5-color-palette-popover opener="opener"></ui5-color-palette-popover>
```
...
```html
<ui5-illustrated-message size="Dialog"></ui5-illustrated-message>
```

Now use `design` instead:

```html
<ui5-illustrated-message design="Dialog"> </ui5-illustrated-message>
```
...
```html
<ui5-breadcrumbs separator-style="Slash"></ui5-breadcrumbs>
```

Now use `separators` instead:

```html
<ui5-breadcrumbs separators="Slash"></ui5-breadcrumbs>
```
    ...
    <ui5-upload-collection mode="SingleSelectBegin">
      <ui5-upload-collection mode="SingleSelectEnd">
        <ui5-tree mode="SingleSelectAuto">
          <ui5-tree mode="None"></ui5-tree></ui5-tree></ui5-upload-collection></ui5-upload-collection></ui5-list
></ui5-list>
```
    ...
    <ui5-upload-collection selection-mode="SingleStart">
      <ui5-upload-collection selection-mode="SingleEnd">
        <ui5-tree selection-mode="SingleAuto">
          ...
          </ui5-tree></ui5-tree></ui5-upload-collection></ui5-upload-collection></ui5-list
></ui5-list>
```
