...
All [Registration Options](#registration-options) except `scope` and `conflictBehavior` can be updated at any time. On a sequence handle the set is narrower still - see [Sequences](#sequences):
