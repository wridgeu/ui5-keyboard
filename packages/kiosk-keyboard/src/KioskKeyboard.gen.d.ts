...
declare module "./KioskKeyboard" {
    ...
    interface $KioskKeyboardSettings extends $ControlSettings {
        ...
        **instance map -> global registry -> built-in**, so an entry
         ...
         * @since 0.1.0
         */
        instanceLayouts?: object | PropertyBindingInfo | `{${string}}`;
        ...
        **instance map -> global locale map -> default locale layouts**.
         ...
         * @since 0.1.0
         */
        instanceMiddleware?: object | PropertyBindingInfo | `{${string}}`;
    ...
    export default interface KioskKeyboard {
        ...
        **instance map -> global registry -> built-in**, so an entry
         ...
         * @since 0.1.0
         */
        setInstanceLayouts(instanceLayouts: object): this;
        ...
        **instance map -> global locale map -> default locale layouts**.
         ...
         * @since 0.1.0
         */
        getInstanceLocaleLayouts(): object;
        ...
        **instance map -> global locale map -> default locale layouts**.
         ...
         * @since 0.1.0
         */
        setInstanceLocaleLayouts(instanceLocaleLayouts: object): this;
         ...
         * @since 0.1.0
         */
        setInstanceMiddleware(instanceMiddleware: object): this;
