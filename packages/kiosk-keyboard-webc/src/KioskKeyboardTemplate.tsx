...
import { hasOnlyEastAsianGlyphs, isSingleGlyph } from "./core/grapheme.js";
      ...
      {layout.map((row, rowIndex) => (
        <div class={KIOSK_KEYBOARD_DOM.classes.row} part="row" key={`row-${rowIndex}`}>
          {row.map((key, colIndex) => {
            ...
            const isEastAsianGlyphLabel = isSingleGlyphLabel && hasOnlyEastAsianGlyphs(label);
                ...
                {hasLabel ? (
                  <span
                    class={{
                      ...
                      [KIOSK_KEYBOARD_DOM.classes.keyLabelEastAsian]: isEastAsianGlyphLabel,
