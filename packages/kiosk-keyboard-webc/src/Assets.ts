/**
 * Registers themes, i18n loaders, and font assets with the UI5 Web
 * Components framework. Import this module before using the component.
 * Run `npm run generate` after editing source CSS or .properties files.
 */
