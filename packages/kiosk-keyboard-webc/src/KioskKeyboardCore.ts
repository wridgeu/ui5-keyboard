// Core entry -- component class WITHOUT built-in layout imports.
// Use "kiosk-keyboard-webc/core" for lean consumption where you
// register only the layouts you need.
