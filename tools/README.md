...
- Compares an explicit manifest of 20 pairs (all 16 `layouts/*` files plus the
  `grapheme`, `auto-repeat`, `shift-state`, and `composition-utils` core
  helpers) after normalization: comments stripped
