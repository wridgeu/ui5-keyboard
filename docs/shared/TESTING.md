...
- **The FLP suite** (`test:kiosk:e2e:flp`) serves the demo app through `packages/demo-app/ui5-flp.yaml`, whose SAPUI5 framework UI5 Tooling downloads into `~/.ui5` on first use; the first run takes minutes rather than seconds.
